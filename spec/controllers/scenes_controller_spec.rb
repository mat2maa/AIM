...
describe ScenesController do
  ...
  let(:valid_attributes) { { "script_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved scene as @scene" do
        ...
        post :create, {:scene => { "script_id" => "invalid value" }}, valid_session
        assigns(:scene).should be_a_new(Scene)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested scene" do
        ...
        Scene.any_instance.should_receive(:update_attributes).with({ "script_id" => "1" })
        put :update, {:id => scene.to_param, :scene => { "script_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the scene as @scene" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Scene.any_instance.stub(:save).and_return(false)
        put :update, {:id => scene.to_param, :scene => { "script_id" => "invalid value" }}, valid_session
        assigns(:scene).should eq(scene)
      end
